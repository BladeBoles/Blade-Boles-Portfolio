  ...
  return (
    <footer className="footer" id="contact">
      ...
      <ul className="footer-contact">  
        <li>
          <a className="footer-items" target="_blank" rel="noopener noreferrer" href="https://github.com/BladeBoles">
            <img className="social-logo" width="64" src="/assets/GitHub.png" alt="GitHub Logo" />
          </a>
        </li>

        <li>
          <a className="footer-items" target="_blank" rel="noopener noreferrer" href="https://www.linkedin.com/in/blade-boles">
